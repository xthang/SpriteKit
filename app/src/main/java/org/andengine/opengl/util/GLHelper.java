...
public class GLHelper {
	...
	public static Buffer getPixels(final Bitmap pBitmap, final PixelFormat pPixelFormat) {
		return GLHelper.getPixels(null, pBitmap, pPixelFormat, ByteOrder.nativeOrder());
	}

	public static Buffer getPixels(final String tag, final Bitmap pBitmap, final PixelFormat pPixelFormat, final ByteOrder pByteOrder) {
		final int[] pixelsARGB_8888 = GLHelper.getPixelsARGB_8888(tag, pBitmap);
	...
	public static int[] getPixelsARGB_8888(final String tag, final Bitmap pBitmap) {
		...
		try {
			...
			Log.e("GL", "!!  error [" + tag + "] " + e.getLocalizedMessage());
			throw e;
		}
