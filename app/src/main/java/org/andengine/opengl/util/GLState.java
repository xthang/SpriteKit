...
public class GLState {
     ...
     * @param pBorder
     */
    public void glTexImage2D(final String tag, final int pTarget, final int pLevel, final Bitmap pBitmap, final int pBorder, final PixelFormat pPixelFormat) {
        final Buffer pixelBuffer = GLHelper.getPixels(tag, pBitmap, pPixelFormat, ByteOrder.BIG_ENDIAN);
    ...
    public void glTexSubImage2D(final int pTarget, final int pLevel, final int pX, final int pY, final Bitmap pBitmap, final PixelFormat pPixelFormat) {
        final Buffer pixelBuffer = GLHelper.getPixels(null, pBitmap, pPixelFormat, ByteOrder.BIG_ENDIAN);
