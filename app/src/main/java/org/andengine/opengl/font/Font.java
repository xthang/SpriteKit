...
public class Font implements IFont {
	...
	@Override
	public void unload() {
		this.mTexture.unload("null");
		this.mFontManager.unloadFont(this);
	}

	public boolean isLoaded() {
		return mTexture.isLoadedToHardware();
	}
	...
	private Letter createLetter(final char pCharacter) throws FontException {
		...
		this.updateTextBounds("createLetter", characterAsString);
	...
	protected void updateTextBounds(final String tag, final String pCharacterAsString) {
		this.mPaint.getTextBounds(pCharacterAsString, 0, 1, this.mTextBounds);
		// Log.d("X-Font", "--  updateTextBounds [" + tag + "] [" + hashCode() + "] " + pCharacterAsString + " - " + fontSize + " - " + " - " + mTextBounds);
	}

	// Thang.X
	public RectF getTextBounds(final String tag, final String text) {
