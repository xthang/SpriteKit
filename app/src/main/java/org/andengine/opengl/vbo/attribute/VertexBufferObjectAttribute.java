 ...
 */
public class VertexBufferObjectAttribute implements Cloneable {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	// Thang.X
	@NonNull
	public VertexBufferObjectAttribute clone() throws CloneNotSupportedException {
		return (VertexBufferObjectAttribute) super.clone();
	}
