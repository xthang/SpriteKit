 ...
 */
public abstract class VertexBufferObject implements IVertexBufferObject, Cloneable {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	protected VertexBufferObjectAttributes mVertexBufferObjectAttributes;
	...
	// Thang.X
	@NonNull
	public VertexBufferObject clone() throws CloneNotSupportedException {
		VertexBufferObject c = (VertexBufferObject) super.clone();
		c.mByteBuffer = BufferUtils.allocateDirectByteBuffer(mCapacity * DataConstants.BYTES_PER_FLOAT);
		c.mByteBuffer.order(ByteOrder.nativeOrder());

		c.mVertexBufferObjectManager = null;
		c.mVertexBufferObjectAttributes = mVertexBufferObjectAttributes.clone();    // TODO this is Shared instance, not clone
		return c;
	}
