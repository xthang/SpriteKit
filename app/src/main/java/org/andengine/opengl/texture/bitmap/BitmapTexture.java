...
public class BitmapTexture extends Texture {
    ...
    protected void writeTextureToHardware(final GLState pGLState) throws IOException {
        ...
        if (preMultipyAlpha) {
            ...
            pGLState.glTexImage2D(null, GLES20.GL_TEXTURE_2D, 0, bitmap, 0, this.mPixelFormat);
        }
    ...
    protected Bitmap onGetBitmap(final Config pBitmapConfig) throws IOException {
        ...
        if (outWidth != null) decodeOptions.outWidth = outWidth;
        if (outHeight != null) decodeOptions.outHeight = outHeight;
